...
if(isset($_POST['submit'])) {
    ...
    (nom, telephone, email, date_reservation, heure, nombre_personnes, instructions)
    
    VALUES
    
    ('$nom', '$telephone', '$email', '$date', '$heure', '$people', '$instructions')";
      ...
      <form class="reservation-form" action="" method="POST">
        ...
        <div class="form-group">
          ...
          <textarea
            ...
            name="instructions"
            rows="4"
            placeholder="Ajoutez des demandes spécifiques ou préférences"
          ></textarea>
        </div>
...
<footer class="main-footer">
    ...
    <div class="footer-container">
      ...
      <div class="footer-section about">
        ...
        <p>
          Damascino vous invite à un voyage culinaire au cœur de la Syrie.
        </p>
      </div>
      ...
      <div class="footer-section social">
        ...
        <div class="social-icons">
          ...
          <a href="https://www.facebook.com/damascino.orientalfood" class="social-icon">
            <img src="images/facebook.png" alt="Facebook">
          </a>

          <a href="https://www.instagram.com/damascino.orientalfood/" class="social-icon">
