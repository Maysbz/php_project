...
<section class="menu-section">
  ...
  <div class="menu-category">
    ...
    <ul class="menu-items">
      <li class="menu-item">
        <img src="soupe.jpg" alt="Soupe aux lentilles">
        <div class="item-details">
          <h3>Soupe aux lentilles</h3>
          <p>Prix : 15 TND</p>
          <a href="commande.html" class="order-btn">Commander</a>   
        </div>
      </li>
      <li class="menu-item">
        <img src="Fattouch.jpg" alt="Fattouch">
        <div class="item-details">
          <h3>Fattouch</h3>
          <p>Prix : 10 TND</p>
          <a href="commande.html" class="order-btn">Commander</a>   
  ...
  <div class="menu-category">
    ...
    <ul class="menu-items">
      <li class="menu-item">
        <img src="kebabmix.jpg" alt="Kebab mixte">
        <div class="item-details">
          <h3>Kebab mixte</h3>
          <p>Prix : 80 TND</p>
          <a href="commande.html" class="order-btn">Commander</a>   
      ...
      <li class="menu-item">
        <img src="majouka.jpg" alt="Majouka">
        <div class="item-details">
          <h3>Majouka</h3>
          <p>Prix : 30 TND</p>
          <a href="commande.html" class="order-btn">Commander</a>   
      ...
      <li class="menu-item">
        <img src="mandi.png" alt="Mandi poulet">
        <div class="item-details">
          <h3>Mandi poulet</h3>
          <p>Prix : 40 TND</p>
          <a href="commande.html" class="order-btn">Commander</a>   
  ...
  <div class="menu-category">
    ...
    <ul class="menu-items">
      ...
      <li class="menu-item">
        <img src="layalilibnan.jpg" alt="Layali lebnan">
        <div class="item-details">
          <h3>Layali lebnan</h3>
          <p>Prix : 15 TND</p>
          <a href="commande.html" class="order-btn">Commander</a>   
  ...
  <div class="menu-category">
    ...
    <ul class="menu-items">
      <li class="menu-item">
        <img src="citronade.jpeg" alt="Citronnade">
        <div class="item-details">
          <h3>Citronnade</h3>
          <p>Prix : 9 TND</p>
          <a href="commande.html" class="order-btn">Commander</a>   
      ...
      <li class="menu-item">
        <img src="Thé_à_la_Menthe.jpg" alt="Thé à la Menthe">
        <div class="item-details">
...
<section class="specialties-section">
  ...
  <div class="specialties-container">
    <div class="specialty-item">
      <img src="samboussek.jpeg" alt="Sambousek" class="specialty-img">
      <h3>Sambousek</h3>
    ...
    <div class="specialty-item">
      <img src="warakenab.jpg" alt="Warak enab" class="specialty-img">
      <h3>Warak enab</h3>
    ...
    <div class="specialty-item">
      <img src="kebba.jpg" alt="Kebba" class="specialty-img">
      <h3>Kebba</h3>
