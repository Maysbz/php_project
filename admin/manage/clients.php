...
<body>
    <div class="admin-container">
        ...
        <div class="table-container">
            ...
            <?php else: ?>
                <p class="message">Aucun client inscrit.</p>
            <?php endif; ?>
        </div>
                    ...
                    <?php if ($contacts && mysqli_num_rows($contacts) > 0): ?>
                        <?php while ($contact = mysqli_fetch_assoc($contacts)): ?>
                            <tr>
                                ...
                                <td class="message-preview"><?php echo htmlspecialchars($contact['message']); ?></td>
                                <td>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="6" class="message">Aucun message de contact.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
