...
<body>
  ...
  <section class="login-section">
    ...
    <p class="login-description">Veuillez entrer vos informations pour vous connecter à votre compte.</p>

    <div class="login-form-container">
      <form class="login-form" action="404.html" method="POST">
        ...
        <p class="signup-link">Pas encore de compte ? <a href="signup.html">S'inscrire</a></p>
      </form>
    </div>
  </section>
